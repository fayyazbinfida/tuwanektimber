...
<section class="page-header bg-faq">
	<div class="container">
		<div class="row">
			<div class="col-8 mx-auto text-center">
				<h2 class="mb-3 text-capitalize text-white">FAQs</h2>
...
<section class="section faq-section">
  <div class="container">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-9">
        <div class="accordion accordion-custom accordion-border-bottom" id="accordionFAQ">
          <div class="accordion-item">
            <h2 class="accordion-header accordion-button h5 border-0 active"
              ...
              aria-controls="collapse-ebd23e34fd2ed58299b32c03c521feb0b02f19d9">When do I get my damage deposit back?
            ...
            <div id="collapse-ebd23e34fd2ed58299b32c03c521feb0b02f19d9"
              ...
              <div class="accordion-body py-0 content">Within 14 days after your last day in the cabin.
          ...
          <div class="accordion-item">
            <h2 class="accordion-header accordion-button h5 border-0 "
              ...
              aria-controls="collapse-a443e01b4db47b3f4a1267e10594576d52730ec1">What constitutes no refund of damage deposit?
            ...
            <div id="collapse-a443e01b4db47b3f4a1267e10594576d52730ec1" class="accordion-collapse collapse border-0 "
              ...
              <div class="accordion-body py-0 content">Unreasonable damage to cabin and contents, hot tub, decks, hand rails. We expect cabin to be left in relative cleanliness, including doing dishes, taking out garbage and disposing of recycling in appropriate recycle and garbage containers provided. Leave the rest to us.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header accordion-button h5 border-0 "
              ...
              aria-controls="collapse-4b82be4be873c8ad699fa97049523ac86b67a8bd">Is there firewood available?
            ...
            <div id="collapse-4b82be4be873c8ad699fa97049523ac86b67a8bd" class="accordion-collapse collapse border-0 "
              ...
              <div class="accordion-body py-0 content">The first night’s fire is on us. Ask us for more information.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header accordion-button h5 border-0 "
              ...
              aria-controls="collapse-3e13e9676a9cd6a6f8bfbe6e1e9fc0881ef247b3">Do we need to bring bed linen?
            ...
            <div id="collapse-3e13e9676a9cd6a6f8bfbe6e1e9fc0881ef247b3" class="accordion-collapse collapse border-0 "
              ...
              <div class="accordion-body py-0 content">No, all beds for 6 have bed linen.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header accordion-button h5 border-0 "
              ...
              aria-controls="collapse-0c2f829793a1f0562fea97120357dd2d43319164">Are towels and kitchen linen supplied?
            ...
            <div id="collapse-0c2f829793a1f0562fea97120357dd2d43319164" class="accordion-collapse collapse border-0 "
              ...
              <div class="accordion-body py-0 content">Yes, but please bring your own beach towels.</div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header accordion-button h5 border-0 "
              ...
              aria-controls="collapse-8fe6730e26db16f15763887c30a614caa075f518">What is your Cancellation Policy?
            ...
            <div id="collapse-8fe6730e26db16f15763887c30a614caa075f518" class="accordion-collapse collapse border-0 "
              ...
              <div class="accordion-body py-0 content">
				<ul>
					<li>
						Any cancellations within 15 days of occupancy – no refund
					</li>
					<li>
						Any cancellations within 16 – 30 days of occupancy – refund of 50% only.
					</li>
					<li>
						Any cancellation of occupancy over 30 days; we’ll try to rebook the time and if successful, we’ll keep $100 and give you back the rest. If we’re not successful, your initial deposit will not be refunded.
					</li>
				  </ul>
			  </div>
            </div>
